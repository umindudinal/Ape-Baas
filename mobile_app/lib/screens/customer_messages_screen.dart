      ...
      child: SingleChildScrollView(
        ...
        child: Column(
          ...
          children: [
            ...
            const Text(
              'ඔබ සේවාවක් වෙන්කරගත් පසු සේවා සපයන්නා සමඟ සම්බන්ධ වී මෙහිදී පණිවිඩ හුවමාරු කරගත හැක.',
              style: TextStyle(
    ...
    return RefreshIndicator(
      ...
      child: ListView.separated(
        ...
        itemBuilder: (context, index) {
          ...
          final partnerName = item['partnerName'] ?? 'පරිශීලකයා';
